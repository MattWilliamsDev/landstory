...
<body  id="master_planning" class="corydon">
...
<div id="container">
	...
	<div id="content">
		...
		<div id="main">
				...
				<a href="/our_projects/master_planning/corydon.php">IDNR, CORYDON STATE HISTORIC SITES MASTER PLAN</a></h2>
				<ul id="gallery">
					<li><img src="/images/projects/master_planning/corydon/detail_1.jpg" /></li>
					<li><img src="/images/projects/master_planning/corydon/detail_2.jpg" /></li>
					<li><img src="/images/projects/master_planning/corydon/detail_3.jpg" /></li>
				</ul>	
